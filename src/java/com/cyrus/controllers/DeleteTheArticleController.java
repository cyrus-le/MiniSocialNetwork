...
public class DeleteTheArticleController extends HttpServlet {
    ...
    private static final Logger logger = Logger.getLogger(DeleteTheArticleController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String txtPostEmail = request.getParameter("txtPostEmail");
            ArticlesDAO dao = new ArticlesDAO();
            String txtPostID = request.getParameter("txtPostID");

            if (member != null) {
                if ((member.getEmail().equals(txtPostEmail))) {
            ...
            logger.error("Error DeleteTheArticleController at: " + e.getMessage());
