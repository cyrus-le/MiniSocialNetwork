<%-- 
    Document   : signup
    Created on : Sep 16, 2020, 4:41:27 PM
    Author     : Cyrus
--%>
...
<html>
    ...
    <body class="bg-light">
        <div class="container">
            <h1>Sign Up</h1>
            <br>
            <form name="action" action="MainController" method="POST">
                ...
                <br/>
                <input type="submit" value="Signup" name="action" class="btn btn-outline-success" />
