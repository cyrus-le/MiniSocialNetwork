 ...
 * @author Cyrus
 */
public class ViewOurPostsController extends HttpServlet {

    private final static Logger logger = Logger.getLogger(ViewOurPostsController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ArticlesDTO> list = DAO.getPostsByAuthor(email, start, POST_PER_PAGE);
