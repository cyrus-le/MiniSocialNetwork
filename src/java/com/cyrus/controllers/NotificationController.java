...
public class NotificationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<NotificationDTO> list = dao.getAllNotificationByEmail(email);

            request.setAttribute("LIST_NOTIFY", list);

        } catch (SQLException | ParseException | NamingException ex) {

            LOGGER.error("Error NotficcationController at: " + ex.getMessage());
        } finally {
