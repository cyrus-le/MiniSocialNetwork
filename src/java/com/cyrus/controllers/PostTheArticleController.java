...
import com.cyrus.utils.SecureUUIDUtil;
...
public class PostTheArticleController extends HttpServlet {
    ...
    private static final Logger logger = Logger.getLogger(PostTheArticleController.class);
    ...
    private ArticlesDTO createNewArticle(final HttpServletRequest req) {
        ...
        try {
            ...
            logger.error("Error image: " + e.getMessage());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("Error PostTheArticleController at: " + e.getMessage());
        } finally {
            request.getRequestDispatcher("SocialNetworkController").forward(request, response);
        }
    }
